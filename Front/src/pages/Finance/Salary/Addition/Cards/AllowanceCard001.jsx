...
export default function AllowanceCard001() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const total = response.data.reduce((acc, curr) => acc + curr.allowance, 0);
    ...
    return (
        <div className="h-40 max-w-sm p-4 bg-green-600 border border-gray-200 rounded-lg shadow w-72 dark:bg-green-600 dark:border-gray-100 hover:bg-green-800">
            <div className='flex'>
                ...
                <label className="mt-4 ml-3 text-3xl font-semibold text-white dark:text-white">Allowance</label>
            </div>
